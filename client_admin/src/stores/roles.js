const roles = {
	...
	admin: {
		...
		view: {
			...
			desc: "Quyền hạn cho phép xem chi tiết tài khoản trị trong danh sách gồm các thông tin như email, mật khẩu, họ và tên... và các vai trò được gán",
			dangerous: "nothing",
		},
		update: {
			id: "638c7606e13b091e37dd84fa",
			name: "Cập nhật quản trị viên",
			desc: "Quyền hạn cho phép cập nhật (sửa) tài khoản trị trong danh sách gồm các thông tin như email, mật khẩu, họ và tên... và các vai trò được gán",
			dangerous: "warning",
		},
		delete: {
			id: "638c7606e13b091e37dd84fb",
			name: "Xóa quản trị viên",
			desc: "Quyền hạn cho phép xóa tài khoản trị trong danh sách và xóa gồm các thông tin như email, mật khẩu, họ và tên... và các vai trò được gán",
			dangerous: "warning",
		},
		statistic: {
			id: "638c7606e13b091e37dd84fc",
			name: "Thống kê quản trị viên",
			desc: "Quyền hạn cho phép xem thông kê các quản trị viên",
			dangerous: "nothing",
		},
	},
	customer: {
		all: {
			...
			desc: "Quyền hạn cho phép toàn quyền quản lý các khách hàng thêm (tạo),xem chi tiết, cập nhật(chỉnh sửa), xóa(gỡ bỏ), thống kê khách hàng (Mức độ nguy hiểm cao: vì bao gồm quyền xóa có thể gây ảnh đến hệ thống)",
			dangerous: "destroy",
		},
		create: {
			id: "638c7606e13b091e37dd84fe",
			name: "Tạo khách hàng",
			desc: "Quyền hạn cho phép tạo hoặc thêm mới khách hàng tên, email sẽ thêm tài khoản vào hệ thống",
			dangerous: "nothing",
		},
		view: {
			id: "638c7606e13b091e37dd84ff",
			name: "Xem chi tiết khách hàng",
			desc: "Quyền hạn cho phép xem chi tiết tài khoản khách hàng gồm các thông tin như tên, email mà khách hàng tồn tại trong hệ thống",
			dangerous: "nothing",
		},
		update: {
			id: "638c7606e13b091e37dd8500",
			name: "Cập nhật khách hàng",
			desc: "Quyền hạn cho phép cập nhật tài khoản khách hàng gồm các thông tin như tên, email mà khách hàng tồn tại trong hệ thống",
			dangerous: "nothing",
		},
		delete: {
			id: "638c7606e13b091e37dd8503",
			name: "Xóa khách hàng",
			desc: "Quyền hạn cho phép xóa tài khoản khách hàng gồm các thông tin như tên, email mà khách hàng tồn tại trong hệ thống",
			dangerous: "warning",
		},
		statistic: {
			id: "638c7606e13b091e37dd8502",
			name: "Thống kê khách hàng",
			desc: "Quyền hạn cho thống kê tài khoản khách hàng gồm các thông tin như tên, email mà khách hàng tồn tại trong hệ thống",
			dangerous: "nothing",
		},
	},
	user: {
		all: {
			id: "638c7606e13b091e37dd84fd",
			name: "Toàn quyền quản lý tài khoản",
			desc: "Quuyền hạn cho phép toàn quyền quản lý các tài khoản thêm (tạo),xem chi tiết, cập nhật(chỉnh sửa), xóa(gỡ bỏ), thống kê tài khoản (Mức độ nguy hiểm cao: vì bao gồm quyền xóa có thể gây ảnh đến hệ thống)",
			dangerous: "destroy",
		},
		create: {
			id: "638c7606e13b091e37dd84fe",
			name: "Tạo tài khoản",
			desc: "Quyền hạn cho phép tạo hoặc thêm mới tài khoản tên, email sẽ thêm tài khoản vào hệ thống",
			dangerous: "nothing",
		},
		view: {
			id: "638c7606e13b091e37dd84ff",
			name: "Xem chi tiết tài khoản",
			desc: "Quyền hạn cho phép xem chi tiết tài khoản gồm các thông tin như tên, email mà tài khoản tồn tại trong hệ thống",
			dangerous: "nothing",
		},
		update: {
			id: "638c7606e13b091e37dd8500",
			name: "Cập nhật tài khoản",
			desc: "Quyền hạn cho phép cập nhật tài khoản gồm các thông tin như tên, email mà tài khoản tồn tại trong hệ thống",
			dangerous: "nothing",
		},
		delete: {
			id: "638c7606e13b091e37dd8503",
			name: "Xóa tài khoản",
			desc: "Quyền hạn cho phép xóa tài khoản gồm các thông tin như tên, email mà tài khoản tồn tại trong hệ thống",
			dangerous: "warning",
		},
		statistic: {
			id: "638c7606e13b091e37dd8502",
			name: "Thống kê tài khoản",
			desc: "Quyền hạn cho thống kê tài khoản gồm các thông tin như tên, email mà tài khoản tồn tại trong hệ thống",
			dangerous: "nothing",
		},
	},
};
